# Generated by Powerlevel10k configuration wizard on 2020-06-23 at 13:02 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER="󰇘"
  # Color of the shortened directory segments.
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=81
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=42
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%62F'   # green foreground
