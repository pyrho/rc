...
function M.configureForLspSaga()
	...
	map(0, "n", "gO", "<cmd>Lspsaga show_cursor_diagnostics<cr>", { silent = true, noremap = true })
...
function M.configureForGlance()
	map(0, "n", "gd", "<cmd>Glance definitions<cr>", { silent = true, noremap = true })

	map(0, "n", "gr", "<cmd>Glance references<cr>", { silent = true, noremap = true })

	map(0, "n", "gy", "<cmd>Glance type_definitions<cr>", { silent = true, noremap = true })
end
